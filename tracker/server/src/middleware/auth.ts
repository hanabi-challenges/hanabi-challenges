...
/**
 * Reads the hanab.live username from the existing site session, finds
 * the tracker user record, resolves the role, and attaches req.trackerUser.
 *
 * Returns 401 if no authenticated session is present or user not found in public.users.
